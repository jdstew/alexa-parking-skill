...
public class GaragesNearbyIntentHandler implements RequestHandler {
	public static final String INTENT_NAME = "get_nearby_garages";
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String speechText = EparkJsonParser.getNearbyGarages(garageName.toLowerCase());
