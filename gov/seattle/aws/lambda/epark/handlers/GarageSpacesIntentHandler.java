...
public class GarageSpacesIntentHandler implements RequestHandler {
	public static final String INTENT_NAME = "get_parking_spaces_at";
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String speechText = EparkJsonParser.getGarageSpaces(garageName.toLowerCase());
